...
export default function DemoProfile() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Privacy Popup */}
      {showPrivacyPopup && (
        <div className="absolute top-96 left-1/2 transform -translate-x-1/2 z-50 max-w-md w-full mx-4">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm text-gray-800">
                    Profiles are private by default. Share your unique profile link with anyone you choose. Your reputation, your control.
                  </p>
                </div>
              </div>
              <button
